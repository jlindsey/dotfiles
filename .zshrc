...
export ZSH=/Users/jlindsey/.oh-my-zsh
...
plugins=(ruby rails osx bundler common-aliases gem tmux vi-mode)
...
export VAULT_URL="https://vault.snapshots.com"
function ss_vault() {
  noglob vault $1 -address=$VAULT_URL ${@[2,-1]}
  return $?
}

alias vault=ss_vault
